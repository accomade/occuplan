...
const occupationStyle = (d, occupations2) => {
  ...
  const o = occupied(day, occupations2);
  const oStarts = occupationStarts(day, occupations2);
  const oEnds = occupationEnds(day, occupations2);
